...
model = LSTM(input_size=30,
             hidden_size=176, 
             num_layers=2,
             dropout=0.33538865521448935)
model.load_state_dict(torch.load('../models/lstm_nhl_model.pt'))
model.eval()
...
df_preds.to_csv("../data/lstm_predictions.csv", index=False)